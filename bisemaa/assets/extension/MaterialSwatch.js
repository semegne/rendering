class MaterialSwatchExtension extends Autodesk.Viewing.Extension {
    constructor(viewer, options) {
        ...
        this._swatch = null;
        this._urn = 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6YmlzZW1hLWJ1Y2tldC9RLTAwMi0xMDAxX01hdC5pcHQ'; // Use your own swatch model URN
    }
    ...
    async getPresets() {
        ...
        console.log(frags)
        // console.log(tree.enumNodeChildren(tree.getRootId()));
